...
def train_eth(data, batch_size, epochs, pool_size, kernel_size, n_classes):
    ...
    # create model
    model = Sequential()
    model.add(Conv2D(16, kernel_size, padding = 'same', input_shape = input_shape, strides=1, activation='relu'))
